...
#### AZURE BLOB STORAGE
AZURE_BLOB_CONNECTION_STRING, AZURE_BLOB_CONTAINER_NAME, AZURE_BLOB_ACCOUNT, AZURE_BLOB_KEY

#### AZURE DOCUMENT INTELLIGENCE
AZURE_DI_ENDPOINT, AZURE_DI_API_KEY, AZURE_DI_MODEL_ID

#### AZURE OPENAI
AZURE_OPENAI_ENDPOINT, AZURE_OPENAI_API_KEY

#### MODEL DEPLOYMENTS
AZURE_OPENAI_EMBEDDING_DEPLOYMENT,AZURE_OPENAI_GPT4O_DEPLOYMENT, AZURE_OPENAI_GPT4O_MINI_DEPLOYMENT

#### AZURE AI SEARCH
AZURE_SEARCH_ENDPOINT, AZURE_SEARCH_API_KEY, AZURE_SEARCH_INDEX_NAME

#### Configurações opcionais
AZURE_SEARCH_SEMANTIC_CONFIG, AZURE_SEARCH_VECTOR_DIMENSION
